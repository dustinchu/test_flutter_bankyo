...
class CourseScreen extends StatefulWidget {
  ...
  @override
  _CourseScreenState createState() => new _CourseScreenState(bankyo,homeSelectId);
}
...
Future<List<CoursePosts>> fetchPosts(http.Client client, Bankyo bankyoUrl,homeSelectId) async {
  final response = await client.get(bankyoUrl.courseListViewUrl+'${homeSelectId}');
